...
DBM_CORE_ANNOUNCE_PULL_FULL			= "Pull in %d sec, DPS wait for %d sec after pull"
DBM_CORE_TIMER_PULL					= "Pull in"
DBM_CORE_TIMER_DPS					= "DPS in"
DBM_CORE_ANNOUNCE_PULL				= "Pull in %d sec"
DBM_CORE_ANNOUNCE_PULL_NOW			= "Pull now!"
DBM_CORE_ANNOUNCE_PULL_DPS_WAIT		= "Pull in %d sec. DPS wait!"
DBM_CORE_ANNOUNCE_PULL_NOW_DPS_WAIT	= "Pull now! No DPS!"
DBM_CORE_ANNOUNCE_DPS				= "DPS in %d sec."
DBM_CORE_ANNOUNCE_DPS_NOW			= "DPS go!"
